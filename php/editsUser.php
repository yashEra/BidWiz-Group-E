...
<div class="container1">
		<div class="main-body">
			<div class="row">
                ...
                <div class="card">
						<div class="card-body">
                        <form action="./classes/editsUserProcess.php" method="post">
						<br>
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<input type="text" name="firstname" class="form-control" value="<?php echo $seller->getFirstName() ?>">
								</div>
							</div>
                            <div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
								<input type="text" name="lastname" class="form-control" value="<?php echo $seller->getLastName() ?>">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
								<input type="text" name="email" class="form-control" value="<?php echo $seller->getEmail() ?>">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
