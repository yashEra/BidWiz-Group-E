    ...
    <!-- ****************************************************************************** -->
      ...
      <div class="row">
        ...
        <?php
          ...
          echo "No items found in Category 3.";
        }
...
<div class="container mt-4">
      ...
      <div class="row">
        ...
        <?php
          ...
          echo "No items found in Category 4.";
        }
...
<div class="container mt-4">
      ...
      <div class="row">
        ...
        ?>
            <div class="col-md-4 mb-4">
              <div class="product ">
              <img src="<?php echo $row['Item_image']; ?>" class="" alt="Item Image"></img>
            <div class="card-body">
              <h5 class="card-title"><?php echo $row['Item_Title']; ?></h5>
              <p class="card-text"><?php echo $row['Description']; ?></p>
              <p class="card-text">Starting Bid: <?php echo $row['Starting_bid_price']; ?>LKR</p>
        ...
        <?php
          ...
          echo "No items found in Category 7.";
        }
